...
public class DataSeeder implements CommandLineRunner {
    ...
    private Show buildShow(Screen screen, Movie movie,
        ...
        com.xyz.booking.enums.ShowTimeSlot slot = deriveTimeSlot(startTime);
    ...
    private com.xyz.booking.enums.ShowTimeSlot deriveTimeSlot(LocalTime time) {
        int hour = time.getHour();
        if (hour < 12) return com.xyz.booking.enums.ShowTimeSlot.MORNING;
        if (hour < 17) return com.xyz.booking.enums.ShowTimeSlot.AFTERNOON;
        if (hour < 21) return com.xyz.booking.enums.ShowTimeSlot.EVENING;
        return com.xyz.booking.enums.ShowTimeSlot.NIGHT;
    }
}
